  ...
  const mentorList = [
    {
      ...
      subject: [
        ...
        { title: 'AI를 움직이는 마법의 주문 프롬프트 과정 AI 리터러시', period: '2024 ~' },
      ...
      history: [
        ...
        { title: '2025 AI트렌드 및 AI툴 활용법 강사노동조합', period: '2025.02' },
        { title: 'AI실무교육 부트캠프 새중앙교회', period: '2024.08~2024.09' },
        { title: '프롬프트 엔지니어 자격증 과정 한국AI융합교육협회', period: '2025.03~2025.04' },
        { title: 'AI 기자단, 나만의 AI뉴스만들기 이천백사중학교', period: '2025.06' },
        { title: '캡컷으로 영상 콘텐츠 만들기 초급반,심화반 강서여성인력개발센터', period: '2025.08' },
        { title: '홍보역량 강화 직원교육 국가유산진흥원', period: '2025.07' },
        { title: 'SBA 구직자를 위한 AI 역량 강화 영등포여성인력개발센터', period: '2025.10 ~' },
        { title: '고립운둔청년을 위한 AI활용 숏폼 쉽게 만들기 중림종합사회복지관', period: '2025.10' },
      ]
    ...
    },
    {
      ...
      subject: [
        { title: '챗GPT 200%활용하기 초급,심화반 생산성·업무자동화', period: '2024 ~' },
        { title: 'AI활용 업무자동화 보고서 쉽게 쓰기 생산성·업무자동화', period: '2024 ~' },
        { title: '챗GPT 나만의 비서 만들기 생산성·업무자동화', period: '2024 ~' },
      ],
      history: [
        { title: 'AI강의 유튜브 ‘에이정’ 운영 Youtube', period: '2024.10~' },
        { title: 'CEO를 위한 AI역량강화 이벤터스', period: '2024.12~' },
        ...
        { title: 'AI실무교육 부트캠프 새중앙교회', period: '2024.08~2024.09' },
        { title: '프롬프트 엔지니어 자격증 과정 한국AI융합교육협회', period: '2025.03~2025.04' },
        { title: 'AI기자단, 나만의 AI뉴스만들기 이천백사중학교', period: '2025.06' },
        { title: '챗GPT활용 보고서와 기획서 쉽게 쓰기 강서여성인력개발센터', period: '2025.07' },
        { title: '챗GPT 200% 활용하기 초급,심화반 강서여성인력개발센터', period: '2025.08' },
        { title: 'SBA 재직자를 위한 AI 역량 강화 영등포여성인력개발센터', period: '2025.10 ~' },
        { title: 'AI활용 숏폼 콘텐츠 제작 강서여성인력개발센터', period: '2025.10 ~' },
